...
import (
	...
	"gopacket/pkg/thirdparty/smb2/internal/ntlm"
	"gopacket/pkg/thirdparty/smb2/internal/spnego"
)
...
// InfoMap returns the NTLM target info from the authentication exchange.
func (i *NTLMInitiator) InfoMap() *ntlm.InfoMap {
