...
// Captured from a real LsarQueryInformationPolicy response against
// alcoholdc.liquorstore.local (172.17.58.152)
...
// Captured from a real LsarLookupSids response for 10 SIDs (RIDs 500-509)
// against alcoholdc.liquorstore.local. 3 resolved, 7 unknown.
// Return value: STATUS_SOME_NOT_MAPPED (0x00000107)
